      ...
      <section className="section-shell pt-32">
        <div className="max-w-3xl">
          ...
          <p className="mt-5 body-copy">
            Browse every product currently loaded in the site catalog. Select your
            colorway, size, and quantity on each product page, then complete
            payment in secure checkout.
          </p>
        </div>
